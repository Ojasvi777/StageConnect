...
const recentPosts = [
	{
		...
		content:
			"Had an amazing experience on set today! 🎬 The whole crew was so supportive ❤️",
		image:
	...
	},
	{
		...
		content:
			"Opening night was a huge success! Thank you to everyone who came to support. 🎭",
		image:
...
const appliedGigs = [
	...
	},
	{
		...
		image:
			"https://images.unsplash.com/photo-1558769132-cb1aea3c12df?w=400",
	},
	{
		id: 3,
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-10">
						...
						<p className="text-lg text-gray-700 max-w-2xl mx-auto">
							Read inspiring stories, industry insights, and tips from talented
